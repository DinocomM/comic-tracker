// src/components/Dashboard/CollectionManager.js
...
const CollectionManager = () => {
  ...
  // Modificamos fetchCollections para recuperar solo colecciones principales (parent = null)
  const fetchCollections = async () => {
    setLoading(true);
    try {
      const response = await CollectionService.getCollections({ parent: 'null' });
    ...
    try {
      if (modalType === 'create') {
        await CollectionService.createCollection({
          ...
          // No se envía parent porque son colecciones principales
        });
  ...
  return (
    <Container className="mt-4">
      ...
      {/* Modal para crear o editar colección (solo colecciones principales) */}
